...
var inBrowser2, mark2, measure2, RE_ARGS2, generateFormatCacheKey2, friendlyJSONstringify2, isNumber2, isDate2, isRegExp2, isEmptyObject2, assign2, _globalThis2, getGlobalThis2, isArray2, isFunction2, isString2, isBoolean2, isObject2, objectToString2, toTypeString2, isPlainObject2, RANGE2;
...
var inBrowser3, mark3, measure3, isNumber3, isArray3, isFunction3, isString3, isObject4, objectToString3, toTypeString3, isPlainObject3, toDisplayString2;
var init_shared_esm_bundler3 = __esm({
  "node_modules/@intlify/runtime/node_modules/@intlify/shared/dist/shared.esm-bundler.js"() {
    ...
    toDisplayString2 = (val) => {
      return val == null ? "" : isArray3(val) || isPlainObject3(val) && val.toString === objectToString3 ? JSON.stringify(val, null, 2) : String(val);
    };
  }
});
...
function createMessageContext(options = {}) {
  ...
  const pluralRule = isObject4(options.pluralRules) && isString3(locale) && isFunction3(options.pluralRules[locale]) ? options.pluralRules[locale] : pluralDefault;
  const orgPluralRule = isObject4(options.pluralRules) && isString3(locale) && isFunction3(options.pluralRules[locale]) ? pluralDefault : void 0;
  ...
  function message(key) {
    const msg = isFunction3(options.messages) ? options.messages(key) : isObject4(options.messages) ? options.messages[key] : false;
  ...
  const type = isPlainObject3(options.processor) && isString3(options.processor.type) ? options.processor.type : DEFAULT_MESSAGE_DATA_TYPE;
  const ctx = {
    ["list"]: list,
    ["named"]: named,
    ["plural"]: plural,
    ["linked"]: (key, modifier) => {
      ...
      return isString3(modifier) ? _modifier(modifier)(msg) : msg;
    },
    ["message"]: message,
    ["type"]: type,
...
function getLocaleChain(ctx, fallback, start) {
  ...
  if (!chain) {
    ...
    const defaults = isArray2(fallback) ? fallback : isPlainObject2(fallback) ? fallback["default"] ? fallback["default"] : null : fallback;
...
function translate(context, ...args) {
  ...
  const defaultMsgOrKey = isString2(options.default) || isBoolean2(options.default) ? !isBoolean2(options.default) ? options.default : key : fallbackFormat ? key : "";
...
function normalizeStyle(value) {
  if (isArray4(value)) {
    ...
    for (let i = 0; i < value.length; i++) {
      const item = value[i];
      const normalized = isString4(item) ? parseStringStyle(item) : normalizeStyle(item);
      if (normalized) {
...
function stringifyStyle(styles) {
  let ret = "";
  if (!styles || isString4(styles)) {
    return ret;
  }
  for (const key in styles) {
    const value = styles[key];
    const normalizedKey = key.startsWith(`--`) ? key : hyphenate(key);
    if (isString4(value) || typeof value === "number" && isNoUnitNumericStyleProp(normalizedKey)) {
...
function looseEqual(a, b) {
  ...
  aValidType = isArray4(a);
  bValidType = isArray4(b);
  if (aValidType || bValidType) {
    return aValidType && bValidType ? looseCompareArrays(a, b) : false;
  }
  aValidType = isObject5(a);
  bValidType = isObject5(b);
  if (aValidType || bValidType) {
    if (!aValidType || !bValidType) {
      return false;
    }
...
var PatchFlagNames, slotFlagsText, GLOBALS_WHITE_LISTED, isGloballyWhitelisted, range, specialBooleanAttrs, isSpecialBooleanAttr, isBooleanAttr, unsafeAttrCharRE, attrValidationCache, propsToAttrMap, isNoUnitNumericStyleProp, isKnownHtmlAttr, isKnownSvgAttr, listDelimiterRE, propertyDelimiterRE, HTML_TAGS, SVG_TAGS, VOID_TAGS, isHTMLTag, isSVGTag, isVoidTag, escapeRE, commentStripRE, toDisplayString3, replacer, EMPTY_OBJ, EMPTY_ARR, NOOP, NO, onRE, isOn, isModelListener, extend, remove, hasOwnProperty3, hasOwn3, isArray4, isMap, isSet, isDate3, isFunction4, isString4, isSymbol2, isObject5, isPromise2, objectToString4, toTypeString4, toRawType, isPlainObject4, isIntegerKey, isReservedProp, isBuiltInDirective, cacheStringFunction, camelizeRE, camelize, hyphenateRE, hyphenate, capitalize, toHandlerKey, hasChanged, invokeArrayFns, def, toNumber, _globalThis3, getGlobalThis3, identRE;
var init_shared_esm_bundler4 = __esm({
  "node_modules/vue/node_modules/@vue/shared/dist/shared.esm-bundler.js"() {
    ...
    toDisplayString3 = (val) => {
      return isString4(val) ? val : val == null ? "" : isArray4(val) || isObject5(val) && (val.toString === objectToString4 || !isFunction4(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
    };
    replacer = (_key, val) => {
      ...
      } else if (isObject5(val) && !isArray4(val) && !isPlainObject4(val)) {
        return String(val);
      }
      return val;
    };
    ...
    hasOwn3 = (val, key) => hasOwnProperty3.call(val, key);
    isArray4 = Array.isArray;
    isMap = (val) => toTypeString4(val) === "[object Map]";
    isSet = (val) => toTypeString4(val) === "[object Set]";
    isDate3 = (val) => toTypeString4(val) === "[object Date]";
    isFunction4 = (val) => typeof val === "function";
    isString4 = (val) => typeof val === "string";
    isSymbol2 = (val) => typeof val === "symbol";
    isObject5 = (val) => val !== null && typeof val === "object";
    isPromise2 = (val) => {
      return isObject5(val) && isFunction4(val.then) && isFunction4(val.catch);
    };
    objectToString4 = Object.prototype.toString;
    toTypeString4 = (value) => objectToString4.call(value);
    toRawType = (value) => {
      return toTypeString4(value).slice(8, -1);
    };
    isPlainObject4 = (val) => toTypeString4(val) === "[object Object]";
    isIntegerKey = (key) => isString4(key) && key !== "NaN" && key[0] !== "-" && "" + parseInt(key, 10) === key;
    ...
    getGlobalThis3 = () => {
      return _globalThis3 || (_globalThis3 = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : {});
    };
...
function createInterpolation(content, loc) {
  return {
    type: 5,
    loc,
    content: isString4(content) ? createSimpleExpression(content, false, loc) : content
  };
}
...
function findDir(node, name, allowEmpty = false) {
  for (let i = 0; i < node.props.length; i++) {
    ...
    if (p.type === 7 && (allowEmpty || p.exp) && (isString4(name) ? p.name === name : name.test(p.name))) {
      return p;
    }
  }
}
...
function hasScopeRef(node, ids) {
  ...
  switch (node.type) {
    ...
    case 8:
      return node.children.some((c) => isObject5(c) && hasScopeRef(c, ids));
    case 5:
    case 12:
  ...
  switch (node.type) {
    ...
    case 8:
      ...
      for (let i = 0; i < node.children.length; i++) {
        ...
        if (isString4(child) || isSymbol2(child)) {
          continue;
        }
...
function createStructuralDirectiveTransform(name, fn) {
  const matches = isString4(name) ? (n) => n === name : (n) => name.test(n);
  return (node, context) => {
    if (node.type === 1) {
      const { props } = node;
...
function genNodeListAsArray(nodes, context) {
  const multilines = nodes.length > 3 || nodes.some((n) => isArray4(n) || !isText$1(n));
  context.push(`[`);
...
function baseCompile2(template, options = {}) {
  ...
  const ast = isString4(template) ? baseParse(template, options) : template;
  ...
  "node_modules/vue/node_modules/@vue/compiler-core/dist/compiler-core.esm-bundler.js"() {
    ...
    transformElement = (node, context) => {
      return function postTransformElement() {
        ...
        const isDynamicComponent = isObject5(vnodeTag) && vnodeTag.callee === RESOLVE_DYNAMIC_COMPONENT;
        let vnodeProps;
        let vnodeChildren;
        let vnodePatchFlag;
        let patchFlag = 0;
...
var require_vue_cjs = __commonJS({
  "node_modules/vue/dist/vue.cjs.js"(exports) {
    ...
    var shared = (init_shared_esm_bundler4(), __toCommonJS(shared_esm_bundler_exports2));
