...
var require_web_storage_cache_min = __commonJS({
  "node_modules/web-storage-cache/dist/web-storage-cache.min.js"(exports, module) {
    !function(a, b) {
      ...
      function e(a2, b2) {
        if (b2 = b2 || new Date(), "number" == typeof a2 ? a2 = a2 === 1 / 0 ? l : new Date(b2.getTime() + 1e3 * a2) : "string" == typeof a2 && (a2 = new Date(a2)), a2 && !d(a2))
      ...
      function g(a2, b2) {
        this.c = new Date().getTime(), b2 = b2 || m;
        var c2 = e(b2);
      ...
      var l = new Date("Fri, 31 Dec 9999 23:59:59 UTC"), m = l, n = { serialize: function(a2) {
...
// dep:web-storage-cache
var web_storage_cache_default = require_web_storage_cache_min();
export {
  web_storage_cache_default as default
};
/*!
